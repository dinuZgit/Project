...
<head>
	...
	<title>Pending Urgent Job Details</title>
...
<body>
	<div class="container-fluid" style="height: 2000px">
		...
		<h1 align="center">Pending Urgent Job Details</h1>
			<br>
		...
		<div class="table-responsive">
			<table id="t01" class="table table-striped table-bordered">
   			...
   			<tr>  
				...
				<td><a href="/servicall/${fault.id}" class="com"><span class="glyphicon glyphicon-check"></span></a></td>
   			</tr>  
